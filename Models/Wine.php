...
class Wine{
    ...
    function create(){
        ...
        $query = "INSERT INTO wine (id, saq_code, type, name, format, price) VALUES(:id, :saq_code, :type, :name, :format, :price)";
    ...
    function update() {
        $query = "update wine set saq_code = :saq_code, type = :type, name = :name, format = :format, price = :price where ID = :id";
        $statement = $this->dbConnection->prepare($query);
    ...
    function getWineBySaqCode($saq_code){
        $query = "select * from wine where saq_code = :saq_code";
